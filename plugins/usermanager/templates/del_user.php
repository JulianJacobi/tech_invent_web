...
<div id="usermanager_deluser">
	...
	<form action="./?plugin=settings&mode=usermanager&modul=Benutzerverwaltung" method="post" id="usermanager_deluser">
		<input type="hidden" value="<?php print($_POST['uname']) ?>" name="uname">
		<input type="hidden" value="del_user" name="step">
		<input type="hidden" value="true" name="delete">
		<a href="./?plugin=settings&mode=usermanager&modul=Benutzerverwaltung" class="usermanager_deluser_link"><button class="system_button" type="button"><?php print($strings['usermanager']['deluser_abbr']) ?></button></a>
